...
namespace FalloutPNP_PipBoy.Dialogs
{
    ...
    public partial class CharacterCreationDlg : Form
    {
        ...
        public CharacterCreationDlg(Char character, List<Race> races)//List<Attributes> items, List<Attributes> races, List<Attributes> traits)
        {
            InitializeComponent();
